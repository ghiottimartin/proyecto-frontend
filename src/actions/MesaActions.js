...
function requestCreateTurnoMesa() {
    return {
        type: REQUEST_CREATE_TURNO_MESA,
    }
}

function reveiceCreateTurnoMesa(message, ruta) {
    return {
        type: RECEIVE_CREATE_TURNO_MESA,
        message: message,
        receivedAt: Date.now(),
        turno: {},
        ruta: ruta
...
export function errorCreateTurnoMesa(error) {
    return {
        type: ERROR_CREATE_TURNO_MESA,
        error: error
    }
}

export function resetCreateTurnoMesa() {
    return {
        type: RESET_CREATE_TURNO_MESA
    }
}

export function createTurnoMesa(turno) {
    return {
        type: CREATE_TURNO_MESA,
        turno: turno
    }
}
