...
//Actions
import { resetFiltros } from "../../../../actions/ReemplazoMercaderiaActions";
...
function Filtros(props) {
    const filtros = props.reemplazos.byId.filtros
    const resetFiltros = props.reemplazos.byId.filtros.resetFiltros
